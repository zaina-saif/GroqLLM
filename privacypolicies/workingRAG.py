...
Answer the questions based on the provided context of the PDFs only.
...
def vector_embedding():
    try:
        if "vectors" not in st.session_state:
            ...
            #load docs
            st.session_state.loader = PyPDFDirectoryLoader("/Users/zainasaif/Desktop/privacypolicies/pdfdocs")
